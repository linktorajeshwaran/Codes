...
import practice3.helpers.Inspection;
import practice3.helpers.MoveToFrontChecker;
import practice3.helpers.Reflection;
import practice3.helpers.RuntimeInstrumentation;
...
import static practice3.p3.Project05TestOrdering.classSpecificTestLevel;
import static practice3.p3.Project05TestOrdering.specialTestLevel;
import static org.junit.jupiter.api.Assertions.*;

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@Tag("C")
public class MoveToFrontDictionaryTests implements IDictionaryNGramTests {
    private static String DICTIONARY_SOURCE = "src/practice3/datastructures/MoveToFrontDictionary.java";
    ...
    public void testFrontRemove() {
        ...
        for (int i = DICT_SIZE; i >= 0; i--) {
            ...
            try {
                ...
                Assertions.assertIterableEquals(values, impl.values(), "Getting a removed key changes the value list");
                if (i != 0) {
